    ...
    public partial class a : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, true, new DateTime(2022, 10, 24, 4, 11, 4, 907, DateTimeKind.Local).AddTicks(70), 204, 1, 1 },
                    { 2, 1, true, new DateTime(2022, 10, 24, 4, 11, 4, 907, DateTimeKind.Local).AddTicks(82), 205, 2, 1 },
                    { 3, 1, true, new DateTime(2022, 10, 24, 4, 11, 4, 907, DateTimeKind.Local).AddTicks(84), 206, 3, 1 },
                    { 4, 1, true, new DateTime(2022, 10, 24, 4, 11, 4, 907, DateTimeKind.Local).AddTicks(85), 207, 4, 1 },
                    { 5, 2, true, new DateTime(2022, 10, 24, 4, 11, 4, 907, DateTimeKind.Local).AddTicks(86), 208, 5, 1 },
                    { 6, 2, true, new DateTime(2022, 10, 24, 4, 11, 4, 907, DateTimeKind.Local).AddTicks(87), 209, 6, 1 },
                    { 7, 3, true, new DateTime(2022, 10, 24, 4, 11, 4, 907, DateTimeKind.Local).AddTicks(88), 210, 7, 1 },
                    { 8, 3, true, new DateTime(2022, 10, 24, 4, 11, 4, 907, DateTimeKind.Local).AddTicks(89), 211, 8, 1 }
                });
